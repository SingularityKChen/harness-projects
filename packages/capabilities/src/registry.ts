...
export type DevelopmentProviderSurface = Expect<Exact<keyof DevelopmentProvider, 'describeCapabilities' | 'getRepository' | 'listBranches' | 'getCommit' | 'getChangeRequest' | 'listChangeRequests' | 'createBranch' | 'createWorktree' | 'getWorktree' | 'createChangeRequest' | 'removeWorktree' | 'reconcile'>>
